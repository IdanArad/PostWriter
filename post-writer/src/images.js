...
const images = [
    { id: 1, src: './assets/facebook.png', title: 'Facebook Post', description: 'a facebook post' },
    { id: 2, src: './assets/instagram.png', title: 'Instagram Post', description: 'an instagram post' },
